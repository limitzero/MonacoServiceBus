...
namespace Monaco.Testing.StateMachines.Internals.Actions
{
	...
	{
		protected BaseTestExpectationAction(IKernel kernel,
		...
		private void RegisterMessage<T>()
		{
			var generator = new ProxyGenerator();
			object proxy = generator.CreateInterfaceProxyWithoutTarget(typeof (T));
			Kernel.AddComponentInstance(typeof (T).Name, typeof (T), proxy.GetType(), proxy);
		}
	}
}